...
thanks: "Replication files are available on the author's Github account (https://github.com/MarikenvdVelden/wording-experiment-populist-attitudes). **Current version**: `r format(Sys.time(), '%B %d, %Y')`;"
anonymous: FALSE
