...
### Additive scale
```{r "addative", fig.align="center", fig.height=8, fig.width=12, results="hide", fig.show='hide'}
...
```{r "wuttke", fig.align="center", fig.height=8, fig.width=12, results="hide", fig.show='hide'}
